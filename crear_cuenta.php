  ...
  <body class="body-login">
    ...
    <div class="container">
      <div class="abs-center">
        <form action="agregar_usuario.php" onsubmit="return buscar()" method="post" class="border p-3 form">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" name="agregar_usuario" id="usuario" placeholder="Nombre de usuario" maxlength="25" required>
          </div>
          <div class="input-group mb-3">
            <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1"><i class="fa fa-lock"></i></span>
            </div>
            <input type="password" name="agregar_password" class="form-control" id="password" placeholder="Contraseña nueva" maxlength="25" required>
          ...
          <div class="input-group mb-3">
            ...
            <input type="password" name="confirmar_password_ag" class="form-control" id="pass_confir" placeholder="Confirmar contraseña" maxlength="25" required>
          </div>
