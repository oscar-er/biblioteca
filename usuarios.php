...
<main role="main" class="container">
  <div class="d-flex align-items-center bg-secondary p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
    <div class="lh-100">
      <h6 class="mb-0 text-white lh-100">Usuarios registrados</h6>
      <small>
        <?php
      ...
      <div class="form-group col-md-12">
        <form class="">
          <div class="input-group">
            ...
            <input type="text" onkeyup="Buscar();" id="busqueda_alumno" class="form-control" placeholder="Buscar registro de alumno" aria-label="Username" aria-describedby="busqueda_alumnos">
          </div>
        </form>
      </div>
    </div>
     ...
     <table class="table table-striped table-hover" id="tabla_alumnos">
       ...
       <tbody>
         <?php
            ...
            $consulta_usuarios = $conn->query("SELECT usuario FROM registros_biblioteca.usuarios;");
