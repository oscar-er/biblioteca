<?php
  ...
  $id_alumno_ed = $_POST['id_alumno_ed'];
  $primer_nombre_ed = $_POST['nombre_alumno_ed'];
  $otros_nombres_ed = $_POST['otros_nombres_ed'];
  $apellido_paterno_ed = $_POST['apellido_paterno_ed'];
  $apellido_materno_ed = $_POST['apellido_materno_ed'];
  $fecha_nacimiento_ed = $_POST['fecha_nacimiento_ed'];
  $nivel_academico_ed = $_POST['grado_ed'];
  $instituo_ed = $_POST['instituto_ed'];
  $domicilio_ed = $_POST['direccion_ed'];
  $telefono_ed= $_POST['telefono_ed'];
  try {
    $sql = $conn->prepare("UPDATE registros_biblioteca.registros SET
      primer_nombre=?,
      otros_nombres=?,
      apellido_paterno=?,
      apellido_materno=?,
      ...
      nivel_academico=?,
      telefono=?,
      domicilio=? WHERE id_alumno=?;");
    $resultado = $sql->execute([$primer_nombre_ed, $otros_nombres_ed, $apellido_paterno_ed, $apellido_materno_ed, $fecha_nacimiento_ed, $instituo_ed, $nivel_academico_ed, $telefono_ed, $domicilio_ed, $id_alumno_ed]);
    header('Refresh: 4; URL=consulta_detalle_alumno.php?registro='.$id_alumno_ed);
    echo '
    <!DOCTYPE html>
    <html lang="es">
    <head>
      ...
      <body class="bg-light">
        ...
        <main role="main" class="container">
          ...
          <div class="alert alert-danger text-center" role="alert">
            El registro no pudo ser actualizado, verifica que los datos sean correctos
          </div>
        </main>
    ';
  }
