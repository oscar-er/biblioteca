<?php
  ...
  $motivo = $_POST['motivo'];
  try {
    $sql_insertar = $conn->prepare("INSERT INTO registros_biblioteca.visitas(id_alumno, fecha_registro, motivo) VALUES (?, ?, ?);");
    $resultado_query = $sql_insertar->execute([$id_alumno, $fecha_registro, $motivo]);
    header('Refresh: 4; URL=visita.php?registro=0');
    echo '
    <!DOCTYPE html>
    <html lang="es">
    <head>
      ...
      <body class="bg-light">
        ...
        <main role="main" class="container">
          ...
          <div class="alert alert-success text-center" role="alert">
            El registro ha sido almacenado correctamente.
          </div>
        </main>
    ';
  } catch (\Exception $e) {
