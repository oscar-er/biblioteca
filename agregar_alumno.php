<?php
  ...
  $primer_nombre_ag = $_POST['primer_nombre'];
  $otros_nombres_ag = $_POST['otros_nombres'];
  $apellido_paterno_ag = $_POST['apellido_paterno'];
  $apellido_materno_ag = $_POST['apellido_materno'];
  $fecha_nacimiento_ag = $_POST['fecha_nacimiento'];
  $nivel_academico_ag = $_POST['nivel'];
  $instituo_ag = $_POST['instituto'];
  $domicilio_ag = $_POST['domicilio'];
  $telefono_ag= $_POST['telefono'];
  try {
    $sql_insertar = $conn->prepare("INSERT INTO registros_biblioteca.registros(primer_nombre, otros_nombres, apellido_paterno, apellido_materno, fecha_nacimiento, instituto, nivel_academico, telefono, domicilio) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);");
    $resultado_query = $sql_insertar->execute([$primer_nombre_ag, $otros_nombres_ag, $apellido_paterno_ag, $apellido_materno_ag, $fecha_nacimiento_ag, $instituo_ag, $nivel_academico_ag, $telefono_ag, $domicilio_ag]);
    header('Refresh: 4; URL=registro_alumno.php');
    echo '
    <!DOCTYPE html>
    <html lang="es">
    <head>
      ...
      <body class="bg-light">
        ...
        <main role="main" class="container">
          ...
          <div class="alert alert-danger text-center" role="alert">
            El alumno no pudo ser registrado correctamnete, verifica que los datos sean correctos y vuelve a intentar
          </div>
        </main>
    ';
  }
