<?php
  ...
  $id_alumno_re = $_POST['id_alumno_re'];
  $fecha_reserva = $_POST['fecha_reserva_re'];
  try {
    $sql_insertar = $conn->prepare("INSERT INTO registros_biblioteca.reservas(id_alumno, fecha_reserva) VALUES (?, ?);");
    $resultado_query = $sql_insertar->execute([$id_alumno_re, $fecha_reserva]);
    header('Refresh: 2; URL=reservar.php?registro=0');
    echo '
    <!DOCTYPE html>
    <html lang="es">
    <head>
      ...
      <body class="bg-light">
        ...
        <main role="main" class="container">
          ...
          <div class="alert alert-success text-center" role="alert">
            El registro ha sido almaceno correctamente.
          </div>
        </main>
    ';
  } catch (\Exception $e) {
    header('Refresh: 4; URL=reservar.php?registro=0');
    echo '
    <!DOCTYPE html>
    <html lang="es">
    <head>
      ...
      <body class="bg-light">
        ...
        <main role="main" class="container">
          ...
          <div class="alert alert-danger text-center" role="alert">
            El registro no pudo almacenarce correctamente, verifica que el alumno exista.
          </div>
        </main>
    ';
  }
