  ...
  <body class="bg-light">
    <script>
      function buscar(){
          ...
          if (opcion=="") {
            window.location.href = 'visita.php?registro=0';
            alert("Ingresa el ID del alumno");
          }else {
            window.location.href = 'visita.php?registro='+opcion;
            $(function() {
              $('#myModal').modal();
            });
          }
...
<main role="main" class="container">
  <div class="d-flex align-items-center bg-secondary p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
    <div class="lh-100">
      <h6 class="mb-0 text-white lh-100">Registro de visitas de alumnos</h6>
      <small>
        <?php
  ...
  <div class="my-3 p-3 bg-white rounded shadow-sm">
    <h3 class="border-bottom border-gray text-center pb-2 mb-0">Bitácora de visitas</h3>
    <br><br>
    <form method="post" action="agregar_visita.php">
      <div class="form-row">
        <div class="form-group col-md-9">
          <label for="id_alumno_clas">ID Alumno</label>
          <input type="text" value="<?php echo $id_alumno; ?>" name="id_alumno" id="id_alumno" class="form-control" id="id_alumno_clas" placeholder="1292">
        </div>
        ...
        <div class="form-group col-md-1">
          <label for="" class="text-white">.</label>
          <button type="button" data-toggle="modal" data-target="#exampleModal" class="btn btn-success form-control" title="Consultar registro de alumnos"><i class="fa fa-users"></i></button>
        </div>
        ...
        <div class="form-group col-md-8">
          ...
          <input type="text" name="motivo" class="form-control" id="motivo" placeholder="Motivo por el que visita el lugar">
        </div>
      </div>
      <div class="form-row">
      </div>
      <br><hr><br>
      <div align="center">
        <button type="submit" class="btn btn-success" style="width: 200px; height: 50px; font-size: 18px;"><i class="far fa-save" style="font-size:26px;"></i> Guardar registro</button>
      </div>
    </form>
  </div>
